...
const {name,email,password} = req.body
  try {
    ...
    const data1 = {name,email,password:hashPass}
...
//token validation
    ...
    } else {   // if token is not valid response return
      return res.json({
        status: false,
...
export { addUser, allUsers, getUser, updateUser, deleteUser, loginUser,logout };
